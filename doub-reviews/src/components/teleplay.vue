<template>
  <div class="hit">
    <div class="hit1">
      <span class="now">最近热门电视剧</span>
      <div class="list">
        <div class="listsonnow">热门</div>
        <div class="listson">国产剧</div>
        <div class="listson">综艺</div>
        <div class="listson">美剧</div>
        <div class="listson">日剧</div>
        <div class="listson">韩剧</div>
        <div class="listson">日本动画</div>
        <div class="listson">纪录片</div>
      </div>
